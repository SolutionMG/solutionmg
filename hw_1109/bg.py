...
class ParallexBackground:
    def __init__(self):
        self.layers = [\
            ParallexLayer('back1.png', 0.3), \
            ParallexLayer('back2.png', 0.7), \
            ParallexLayer('back3.png', 1.0), \
        ]
...
class InfiniteBackground:
    def __init__(self):
        ...
        self.width = self.image.w
        self.height = self.image.h
        self.min_x, self.min_y = -2000000, -2000000 #무한대
        self.max_x, self.max_y = 2000000, 2000000, #무한대
        self.x, self.y = 0, 0
        self.target = None
    def clamp(self, o):
        o.x = clamp(self.min_x, o.x, self.max_x)
